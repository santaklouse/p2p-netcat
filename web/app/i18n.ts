...
export const uiText = {
  en: {
    ...
    nativeOnly: "Native WebRTC only",
    nativeOnlyHelp: "Disable the delayed Trystero compatibility fallback",
  ...
  ru: {
    ...
    nativeOnly: "Только native WebRTC",
    nativeOnlyHelp: "Отключить отложенный Trystero fallback совместимости",
...
const englishDiagnosticFragments: ReadonlyArray<readonly [string, string]> = [
  ...
  ["WebRTC: pairing token отключает публичный Trystero fallback", "WebRTC: the pairing token disables the public Trystero fallback"],
  ["WebRTC native-only: Trystero fallback отключён", "WebRTC native-only: Trystero fallback disabled"],
  [
